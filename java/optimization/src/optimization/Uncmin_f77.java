...
public class Uncmin_f77 extends Object {
    ...
    public Uncmin_f77(boolean outputResults) {
    ...
    public void optif0_f77(int n, double x[], Uncmin_methods minclass,
 ...
 */
    ...
    public void optif9_f77(int n, double x[], Uncmin_methods minclass,
 ...
 */
    ...
    public void bakslv_f77(int n, double a[][], double x[], double b[]) {
 ...
 */
    ...
    public void chlhsn_f77(int n, double a[][], double epsm,
 ...
 */
    ...
    public void choldc_f77(int n, double a[][], double diagmx,
 ...
 */
    ...
    public void dfault_f77(int n, double x[], double typsiz[],
 ...
 */
    ...
    public void dogdrv_f77(int n, double x[], double f[], double g[],
 ...
 */
    ...
    public void dogstp_f77(int n, double g[], double a[][], double p[],
 ...
 */
    ...
    public void forslv_f77(int n, double a[][], double x[],
    double b[]) {
 ...
 */
    ...
    public void fstocd_f77(int n, double x[], Uncmin_methods minclass,
 ...
 */
    ...
    public void fstofd_f77(int n, double xpls[], Uncmin_methods minclass,
 ...
 */
    ...
    public void grdchk_f77(int n, double x[], Uncmin_methods minclass,
 ...
 */
        ...
        output(" of the gradient method.\n\n\n");
        output("Component   Analytic   Finite Difference\n\n");
    ...
    public void heschk_f77(int n, double x[], Uncmin_methods minclass,
 ...
 */
        ...
        output("\nThere appears to be an error in the coding");
        output(" of the Hessian method.\n\n\n");
        output("Row   Column   Analytic   Finite Difference\n\n");
    ...
    public void hookdr_f77(int n, double x[], double f[], double g[],
 ...
 */
    ...
    public void hookst_f77(int n, double g[], double a[][], double udiag[],
 ...
 */
    ...
    public void hsnint_f77(int n, double a[][], double sx[],
    int method[]) {
 ...
 */
    ...
    public void lltslv_f77(int n, double a[][], double x[],
    double b[]) {
 ...
 */
    ...
    public void lnsrch_f77(int n, double x[], double f[],
 ...
 */
    ...
    public void mvmltl_f77(int n, double a[][], double x[],
    double y[]) {
/*
 ...
 */
    ...
    public void mvmlts_f77(int n, double a[][], double x[],
    double y[]) {
/*
 ...
 */
    ...
    public void mvmltu_f77(int n, double a[][], double x[],
    double y[]) {
/*
 ...
 */
    ...
    public void optchk_f77(int n, double x[], double typsiz[],
 ...
 */
        ...
        if ((msg[1]/2)%2 == 1 && iagflg[1] == 0) {
            ...
            output(" be accepted as properly coded,\n");
            output("OPTCHK   msg = " + msg + ",\n");
            output("OPTCHK   but an analytic gradient is not");
            output(" supplied,\n");
            output("OPTCHK   iagflg = " + iagflg[1] + ".\n\n");
        ...
        if ((msg[1]/4)%2 == 1 && iahflg[1] == 0) {
            ...
            output(" be accepted as properly coded,\n");
            output("OPTCHK   msg = " + msg + ",\n");
            output("OPTCHK   but an analytic Hessian is not");
            output(" supplied,\n");
            output("OPTCHK   iahflg = " + iahflg[1] + ".\n\n");
        ...
        if (n == 1 && msg[1]%2 == 0) {
            ...
            output("inefficient for problems of size 1.\n");
            output("OPTCHK   You might want to try Fmin instead.\n\n");
    ...
    public void optdrv_f77(int n, double x[], Uncmin_methods minclass,
    double typsiz[], double fscale[], int method[],
    int iexp[], int msg[], int ndigit[], int itnlim[],
    int iagflg[], int iahflg[], double dlt[],
    double gradtl[], double stepmx[], double steptl[],
 ...
 */
        ...
        if ((msg[1]/8)%2 != 1) {
            ...
            output("OPTDRV      Number of good digits in");
            output(" f_to_minimize = " + ndigit[1]+"\n");
            output("OPTDRV      Gradient flag");
            output(" = " + iagflg[1]+"\n");
            output("OPTDRV      Hessian flag");
            output(" = " + iahflg[1]+"\n");
            output("OPTDRV      Expensive function calculation flag");
            output(" = " + iexp[1]+"\n");
            output("OPTDRV      Method to use");
            output(" = " + method[1]+"\n");
            output("OPTDRV      Iteration limit");
            output(" = " + itnlim[1]+"\n");
            output("OPTDRV      Machine epsilon");
            output(" = " + epsm+"\n");
            output("OPTDRV      Maximum step size");
            output(" = " + stepmx[1]+"\n");
            output("OPTDRV      Step tolerance");
            output(" = " + steptl[1]+"\n");
            output("OPTDRV      Gradient tolerance");
            output(" = " + gradtl[1]+"\n");
            output("OPTDRV      Trust region radius");
            output(" = " + dlt[1]+"\n");
            output("OPTDRV      Relative noise in");
            output(" f_to_minimize = " + rnf+"\n");
            output("OPTDRV      Analytical fd tolerance");
            output(" = " + analtl+"\n");
        }
    ...
    public void optstp_f77(int n, double xpls[], double fpls[],
 ...
 */
        ...
        if (iretcd[1] == 1) {
            ...
            if ((msg[1]/8)%2 == 0) {
                ...
                output(" to locate a point lower than x.\n");
                output("OPTSTP    Either x is an approximate local");
                output(" minimum of the function,\n");
                output("OPTSTP    the function is too nonlinear for");
                output(" this algorithm, or\n");
                output("OPTSTP    steptl is too large.\n");
            }
            ...
            if (rgx <= gradtl[1]) {
                ...
                if ((msg[1]/8)%2 == 0) {
                    ...
                    output(" to zero.\n");
                    output("OPTSTP    The current iterate is probably");
                    output(" a solution.\n");
                }
            ...
            if (itncnt[1] >= itnlim[1]) {
                ...
                if ((msg[1]/8)%2 == 0) {
                    ...
                    output("OPTSTP    The algorithm failed.\n");
                }
            ...
            if ((msg[1]/8)%2 == 0) {
                ...
                output(" five consecutive times.\n");
                output("OPTSTP    Either the function is unbounded");
                output(" below,\n");
                output("OPTSTP    becomes asymptotic to a finite value");
                output(" from above in some direction, or\n");
                output("OPTSTP    stepmx is too small.\n");
    ...
    public void qraux1_f77(int n, double r[][], int i) {
 ...
 */
    ...
    public void qraux2_f77(int n, double r[][], int i,
    double a, double b) {
 ...
 */
    ...
    public void qrupdt_f77(int n, double a[][],
    double u[], double v[]) {
 ...
 */
    ...
    public void result_f77(int n, double x[], double f[],
    double g[], double a[][],
 ...
 */
    ...
    public void sclmul_f77(int n, double s, double v[],
    double z[]) {
 ...
 */
    ...
    public void secfac_f77(int n, double x[], double g[],
 ...
 */
    ...
    public void secunf_f77(int n, double x[], double g[], double
 ...
 */
    ...
    public void sndofd_f77(int n, double xpls[], Uncmin_methods minclass,
    double fpls[], double a[][], double sx[],
 ...
 */
    ...
    public void tregup_f77(int n, double x[], double f[], double g[],
