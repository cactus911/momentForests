...
public class PDFPlotter extends JFrame {
    ...
    public static void plotKernelDensity(Jama.Matrix m, String title, int col) {
        ArrayList<Double> data = IntStream.range(0, m.getRowDimension())
                .mapToObj(i -> m.get(i, col))
                .collect(Collectors.toCollection(ArrayList::new));
        plotKernelDensity(data, title);
    }
